...
import br.edu.materdei.tas.desktop.gui.core.CPFDocument;
...
public class ClienteDialog extends GenericDialogImpl {
     ...
     * @param cliente
     */
    public ClienteDialog(java.awt.Frame parent, JSONObject cliente) {
        super(parent, true);
        ...
        tfCPF.setDocument(new CPFDocument());
...
//GEN-END:variables
    private void setCliente(JSONObject cliente) {
        this.cliente = cliente;
        tfCodigo.setText(cliente.getString("codigo"));
        tfNome.setText(cliente.getString("nome"));
        tfCPF.setText(cliente.getString("cpf"));
        tfEmail.setText(cliente.getString("email"));
    }
    ...
    public void salvar() {
        ...
        try {
            ...
            //Altera valor do objeto Cliente
            cliente.put("nome", tfNome.getText());
            cliente.put("codigo", tfCodigo.getText());
            cliente.put("cpf", tfCPF.getText().replace(".", "").replace("-", ""));
            cliente.put("email", tfEmail.getText());
           
            try {
                BackendService.save("clientes", this.cliente);
    ...
    public void validarDados() throws NotValidateException {
        ...
        if (tfCPF.getText().equals("")) {
            this.fieldsEmpty.add("O campo \"CPF\" deve ser preenchido.");
        }
