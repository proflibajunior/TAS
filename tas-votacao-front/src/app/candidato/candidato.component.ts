...
import { CandidatoEntity, CandidatoService } from '../_services/candidato.service';
...
export class CandidatoComponent implements OnInit {
  ...
  public displayedColumns: string[] = ['codigo','nome','numero','email', 'endereco', 'partido', 'ativo', 'options'];
  ...
  constructor(private service: CandidatoService, private partidoService: PartidoService, private snakBar: MatSnackBar,
  ...
  ngOnInit(): void {
    ...
    this.service.listar().subscribe(result => {
      ...
      //Carrega os partidos
      this.partidoService.listar().subscribe(result => {
